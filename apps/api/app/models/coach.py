...
CoachMissionType = Literal["guided_scene", "picture_story", "listen_retell"]
...
CoachMissionAI = Annotated[
    Union[GuidedSceneMissionAI, PictureStoryMissionAI, ListenRetellMissionAI],
...
CoachMission = Annotated[
    Union[GuidedSceneMission, PictureStoryMission, ListenRetellMission],
    Field(discriminator="type"),
]
