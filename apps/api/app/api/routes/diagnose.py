...
async def diagnose(
    ...
    # The dependency resolves either the deployment default pair or the
    # learner's explicit allowlisted/BYOK choice. Fast and Deep remain
    # selectable without exposing server credentials.
    ...
    if existing_hash and (
        ...
        if prior:
            ...
            reconstructed = {
                ...
                "naturalRewrite": prior.get("naturalRewrite"),
                "errors": prior_errors,
                "skillUpdates": [],
...
def _llm_and_persist(req, profile, text_hash, request_id, started, diagnosis_mode, identity, llm_provider, claim):
    ...
    submission = {
        ...
        "naturalRewrite": diagnostic.naturalRewrite,
