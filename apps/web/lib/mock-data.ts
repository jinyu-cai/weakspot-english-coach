      ...
      tasks: [
        {
          ...
          completed: true,
          exercises: [
            { id: "pex_001", promptZh: "找出句子中的动词时态错误并改正", question: "Yesterday I walk to the park and play with my dog.", answer: "Yesterday I walked to the park and played with my dog.", explanationZh: "\"Yesterday\"表示过去，\"walk\"→\"walked\"，\"play\"→\"played\"。规则动词加-ed构成过去式。" },
            { id: "pex_002", promptZh: "找出句子中的动词时态错误并改正", question: "She finish her homework before dinner last night.", answer: "She finished her homework before dinner last night.", explanationZh: "\"last night\"是过去时间标志词，\"finish\"→\"finished\"。" },
            { id: "pex_003", promptZh: "找出句子中的动词时态错误并改正", question: "They arrive at the airport two hours early and wait for their flight.", answer: "They arrived at the airport two hours early and waited for their flight.", explanationZh: "整个句子描述过去事件，\"arrive\"→\"arrived\"，\"wait\"→\"waited\"。" },
            { id: "pex_004", promptZh: "找出句子中的动词时态错误并改正", question: "Last summer we travel to Japan and visit many temples.", answer: "Last summer we traveled to Japan and visited many temples.", explanationZh: "\"Last summer\"表示过去，\"travel\"→\"traveled\"，\"visit\"→\"visited\"。" },
            { id: "pex_005", promptZh: "找出句子中的动词时态错误并改正", question: "The meeting start at 9 AM and end at noon yesterday.", answer: "The meeting started at 9 AM and ended at noon yesterday.", explanationZh: "\"yesterday\"是过去时间标志词，\"start\"→\"started\"，\"end\"→\"ended\"。" },
            { id: "pex_006", promptZh: "找出句子中的动词时态错误并改正", question: "He promise to help me but then he change his mind.", answer: "He promised to help me but then he changed his mind.", explanationZh: "两个动作都发生在过去，\"promise\"→\"promised\"，\"change\"→\"changed\"。" },
            { id: "pex_007", promptZh: "找出句子中的动词时态错误并改正", question: "We move to this city five years ago and like it very much.", answer: "We moved to this city five years ago and liked it very much.", explanationZh: "\"five years ago\"明确表示过去，\"move\"→\"moved\"，\"like\"→\"liked\"。" },
            { id: "pex_008", promptZh: "找出句子中的动词时态错误并改正", question: "The students study hard and pass the exam last month.", answer: "The students studied hard and passed the exam last month.", explanationZh: "\"last month\"是过去标志，\"study\"→\"studied\"（y变i加ed），\"pass\"→\"passed\"。" },
            { id: "pex_009", promptZh: "找出句子中的动词时态错误并改正", question: "I call my mother and talk to her for an hour this morning.", answer: "I called my mother and talked to her for an hour this morning.", explanationZh: "\"this morning\"（已过去）表示过去，\"call\"→\"called\"，\"talk\"→\"talked\"。" },
            { id: "pex_010", promptZh: "找出句子中的动词时态错误并改正", question: "She open the door, look outside, and close it again.", answer: "She opened the door, looked outside, and closed it again.", explanationZh: "连续过去动作，\"open\"→\"opened\"，\"look\"→\"looked\"，\"close\"→\"closed\"。" },
          ],
        },
        {
          id: "p1-t2",
          ...
          completed: false,
          exercises: [
            { id: "pex_011", promptZh: "用括号中动词的过去式填空", question: "I ____ (go) to the supermarket and ____ (buy) some groceries.", answer: "I went to the supermarket and bought some groceries.", explanationZh: "go→went, buy→bought，都是不规则动词。" },
            { id: "pex_012", promptZh: "用括号中动词的过去式填空", question: "She ____ (write) a letter and ____ (send) it to her friend.", answer: "She wrote a letter and sent it to her friend.", explanationZh: "write→wrote, send→sent。" },
            { id: "pex_013", promptZh: "用括号中动词的过去式填空", question: "The children ____ (run) to the playground and ____ (begin) to play.", answer: "The children ran to the playground and began to play.", explanationZh: "run→ran, begin→began，元音变化型不规则动词。" },
            { id: "pex_014", promptZh: "用括号中动词的过去式填空", question: "He ____ (take) the bus and ____ (get) off at the wrong stop.", answer: "He took the bus and got off at the wrong stop.", explanationZh: "take→took, get→got。" },
            { id: "pex_015", promptZh: "用括号中动词的过去式填空", question: "We ____ (eat) dinner and then ____ (drink) some coffee.", answer: "We ate dinner and then drank some coffee.", explanationZh: "eat→ate, drink→drank。" },
            { id: "pex_016", promptZh: "用括号中动词的过去式填空", question: "She ____ (speak) to the manager and ____ (tell) him the problem.", answer: "She spoke to the manager and told him the problem.", explanationZh: "speak→spoke, tell→told。" },
            { id: "pex_017", promptZh: "用括号中动词的过去式填空", question: "They ____ (swim) in the lake and ____ (catch) some fish.", answer: "They swam in the lake and caught some fish.", explanationZh: "swim→swam, catch→caught。" },
            { id: "pex_018", promptZh: "用括号中动词的过去式填空", question: "I ____ (think) about it and ____ (make) my decision.", answer: "I thought about it and made my decision.", explanationZh: "think→thought, make→made。" },
            { id: "pex_019", promptZh: "用括号中动词的过去式填空", question: "The teacher ____ (give) us homework and ____ (leave) the classroom.", answer: "The teacher gave us homework and left the classroom.", explanationZh: "give→gave, leave→left。" },
            { id: "pex_020", promptZh: "用括号中动词的过去式填空", question: "He ____ (find) his keys and ____ (put) them in his pocket.", answer: "He found his keys and put them in his pocket.", explanationZh: "find→found, put→put（过去式不变）。" },
          ],
        },
      ],
    },
